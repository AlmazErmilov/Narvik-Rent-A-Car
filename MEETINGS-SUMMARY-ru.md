...
* Добавить поля "start_time", "end_time", "status" в таблицу "bookings".
* Добавить поле "amount" в таблицу "payments".
* Добавить поле "payment_link" в таблицу "payments".
* Добавить поле "contract_sent" (boolean) в таблицу "bookings".
* Добавить поле "driver_license_image" (string) в таблицу "customers".
* Добавить поле "client_comment" (text) в таблицу "bookings".
* Добавить поле "admin_comment" (text) в таблицу "bookings".
* Переименовать поле "car_id" в "vehicle_id" в таблицах "bookings" и "cars".
* Добавить таблицу "locations" с полями "city", "place", "additional_info".
* Связать таблицы "bookings" и "locations" через поля "pickup_location_id" и "return_location_id".
* Реализация REST API:
